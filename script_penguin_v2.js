...
const children = [
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({ text: 'v2修正：①個体識別根拠　②11,000km根拠　③五感描写追加　④背景を行動描写に　⑤CTA強化', font: 'Arial', size: 20, color: 'C0392B' }),
    ]
  }),
  ...
  blank(),
  p('夕食はいつも一人だった。'), // ← 修正④：状況説明→行動描写
  p('テーブルの向かいに誰もいない夜が、何年も続いていた。'),
  p('それでも、毎朝夜明け前に起き、舟を出し、夕方に帰る。'),
  p('海だけは、いつもそこにあった。'),
  blank(),
  p('「海は正直だ。裏切らない」'),
  p('それが口癖だった。'),
  ...
  note('BGM：ギターをやめ、ピアノのみに。緊張感と静けさ。'),
  blank(),
  ...
  p('そういう鳥が打ち上げられることを、ジョアンは何度も見ていた。'),
  p('たいていは、もう助からない。'),
  blank(),
  p('それでも、彼はそのペンギンをそっと抱き上げた。'),
  blank(),
  p('冷たかった。', { bold: true }), // ← 修正③：五感描写追加
  p('重さは4キロほど。骨の感触が手に伝わった。'),
  p('油の匂いが、ジョアンの手に染みついた。'),
  blank(),
  p('「生きている」'),
  blank(),
  p('ジョアンは家に連れて帰った。'),
  p('油を丁寧に洗い落とすのに、丸一日かかった。'),
  p('小魚を与えた。最初の3日間、ペンギンは食べなかった。'),
  p('4日目、ほんの少し食べた。'),
  p('1週間後、立ち上がった。'),
  blank(),
  ...
  p('小さくて温かい重みが、膝にあった。', { italic: true }), // ← 五感強化
  blank(),
  ...
  note('BGM：静寂から始まり、ゆっくりとストリングスが高まる。'),
  blank(),
  ...
  p('この話を耳にした生物学者が、後に調査に訪れた。'), // ← 修正⑤：ドラマ形式に
  p('マゼランペンギンの羽の模様と身体的特徴を詳細に記録し、'),
  p('翌年現れたペンギンと照合した結果、同一個体であることが確認されたという。'), // ← 修正①：個体識別根拠
  blank(),
  p('また、マゼランペンギンの主な繁殖地はアルゼンチン南部であり、'),
  p('この海岸との距離を研究者が測定したところ、およそ11,000キロメートルに達した。'), // ← 修正②：距離根拠
  blank(),
  ...
  p('その生物学者は、こう述べた。'),
  blank(),
  p('「なぜこのペンギンがここへ来るのか、正確にはわからない。', { italic: true }),
  p('ただ、ジョアンを見つけると行動が明らかに変わる。', { italic: true }),
  p('あれは、愛着と呼ぶしかない」', { italic: true }),
  blank(),
  ...
  p('そして——あなた自身が、誰かにとっての「ジョアン」になれた瞬間はありますか？', { bold: true }), // ← 修正⑥：CTA強化
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync('/mnt/user-data/outputs/台本_ペンギンと老漁師_v2.docx', buf);
  console.log('done');
});
